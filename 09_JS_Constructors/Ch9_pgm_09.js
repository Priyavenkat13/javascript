...
player1.showInfo("=");
var player2 = new Player("Dax", 70);
var player3 = new Player("Jara", 80);


player2.place = library;
player3.place = library;
player2.addItem("a magic potion");
player2.addItem("a golden shield");
player3.addItem("an ancient book");
player3.addItem("a silver dagger");
